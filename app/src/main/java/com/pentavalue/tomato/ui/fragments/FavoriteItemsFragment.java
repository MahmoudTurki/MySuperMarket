 ...
 * {@link FavoriteItemsFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link FavoriteItemsFragment#newInstance} factory method to
...
public class FavoriteItemsFragment extends BaseFragment {
     ...
     * @return A new instance of fragment FavoriteItemsFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static FavoriteItemsFragment newInstance() {
        FavoriteItemsFragment fragment = new FavoriteItemsFragment();
    ...
    private void setListItems(RecyclerView recyclerView, List<Items> list) {
        if (!ValidatorUtils.isEmpty(list)) {
            ItemsAdapter adapter = new ItemsAdapter(getActivity(), list, Params.Favourite.FAVOURITE);
